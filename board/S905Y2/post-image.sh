...
cp -a $BR2_EXTERNAL_CUSTOM_AUDIO_INJECTOR_PATH/board/S905Y2/vars.txt $BINARIES_DIR/

# Generate the uboot script
echo creating boot.scr
$HOST_DIR/bin/mkimage -C none -A arm -T script -a 0x00c00000 -e 0x00c00000 -n 'flatmax load script' -d $BR2_EXTERNAL_CUSTOM_AUDIO_INJECTOR_PATH/board/S905Y2/boot.cmd $BINARIES_DIR/boot.scr
...
$BASE_DIR/../support/scripts/genimage.sh -c $BR2_EXTERNAL_CUSTOM_AUDIO_INJECTOR_PATH/board/S905Y2/genimage.cfg
